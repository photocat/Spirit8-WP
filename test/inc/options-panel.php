<?php
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Contats', 'redux-framework-demo' ),
        'id'               => 'basic-contacts',
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => __( 'Input your contacts.', 'redux-framework-demo' ),
        'fields'           => array(
          array(
              'id'       => 'phone_label',
              'type'     => 'text',
              'title'    => __( 'Text Field', 'redux-framework-demo' ),
              'subtitle' => __( 'Введит лейбл', 'redux-framework-demo' ),
              'desc'     => __( 'Описание', 'redux-framework-demo' ),
              'default'  => 'Наш номер телефона',
          ),
          array(
              'id'       => 'phone_number',
              'type'     => 'text',
