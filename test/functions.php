...
function test_scripts() {
	...
	wp_enqueue_style( 'test-libs.min',  get_template_directory_uri() . '/assets/css/libs.min.css');
	wp_enqueue_style( 'test-main',  get_template_directory_uri() . '/assets/css/main.css');
	wp_enqueue_script( 'test-libs.min', get_template_directory_uri() . '/assets/js/libs.min.js', array(), '1.0', true );
	wp_enqueue_script( 'tabs', get_template_directory_uri() . '/assets/js/tabs.js', array(), '1.0', true );
	wp_enqueue_script( 'test-common', get_template_directory_uri() . '/assets/js/common.js', array(), '1.0', true );
